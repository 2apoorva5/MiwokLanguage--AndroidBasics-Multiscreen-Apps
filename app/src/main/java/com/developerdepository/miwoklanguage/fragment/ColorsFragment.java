...
public class ColorsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View layout = inflater.inflate(R.layout.fragment_colors, container, false);
        ...
        /* Create an ArrayList of Color Translation - Translation is a model class */
        ArrayList<Translation> colorTranslations = new ArrayList<>();
        colorTranslations.add(new Translation(
                R.drawable.color_red, R.raw.color_red, "weṭeṭṭi", "Red"));
        colorTranslations.add(new Translation(
                R.drawable.color_green, R.raw.color_green, "chokokki", "Green"));
        colorTranslations.add(new Translation(
                R.drawable.color_brown, R.raw.color_brown, "ṭakaakki", "Brown"));
        colorTranslations.add(new Translation(
                R.drawable.color_gray, R.raw.color_gray, "ṭopoppi", "Gray"));
        colorTranslations.add(new Translation(
                R.drawable.color_black, R.raw.color_black, "kululli", "Black"));
        colorTranslations.add(new Translation(
                R.drawable.color_white, R.raw.color_white, "kelelli", "White"));
        colorTranslations.add(new Translation(
                R.drawable.color_dusty_yellow, R.raw.color_dusty_yellow, "ṭopiisә", "Dusty Yellow"));
        colorTranslations.add(new Translation(
                R.drawable.color_mustard_yellow, R.raw.color_mustard_yellow, "chiwiiṭә", "Mustard Yellow"));

        /* Custom Adapter Class to populate the ListView */
        TranslationAdapter translationAdapter = new TranslationAdapter(requireActivity(), colorTranslations, R.color.colorCategoryColors);
